          ...
          <div className="lg:w-1/2">
            ...
            >
              ...
              <div 
                ...
                className="w-full aspect-[4/3] max-h-[500px] bg-[#F8F9FA] rounded-[2rem] p-2 flex items-center justify-center border border-secondary-200 shadow-sm relative overflow-hidden group cursor-zoom-in"
              >
